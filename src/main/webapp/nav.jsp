...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbarcustom">
	...
	<i class="fa fa-book" aria-hidden="true"></i>E_Notes</a>
	...
	<%if(user1==null){%>
		<ul class="navbar-nav mr-auto">
			...
			<i class="fa fa-plus" aria-hidden="true"></i>Add notes</a>
			</li>
		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link " href="shownotes?id=<%=user1.getId()%>">
			<i class="fa fa-eye" aria-hidden="true"></i>
			show Notes</a></li>
		</ul>
